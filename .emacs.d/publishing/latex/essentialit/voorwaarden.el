...
(add-to-list 'org-latex-classes
  '("aperam"
"
\\newcommand*{\\TemplatePath}{C:/users/rkiggen/.emacs.d/publishing/latex/aperam}%
...
\\node [inner sep=0pt,outer sep=0pt] at (0,0) {\\includegraphics[width=\\paperwidth,height=\\paperheight]{\\TemplatePath/images/cover.jpg}};

\\node at  (0,5) [opacity=1.0] {\\parbox[b][0.5\\textheight]{\\textwidth}{%
  \\begin{raggedright}
  \\leavevmode
    \\vskip 1cm
  {\\mytitlefont\\fontsize{75}{85}\\bfseries\\color{white}{\\@title}\\par}
    \\vskip 1cm
...
\\vfill
\\end{raggedright}}};
\\node at (0,-10) [opacity=1] {\\parbox[b][0.3\\textheight]{\\textwidth}{%
\\begin{raggedright}
\\vfill
{\\myauthorfont\\bfseries{Essential IT}}
    \\newline
{\\myauthorfont© 2018 \\@author}
    \\newline
          {\\myauthorfont\\href{mailto:robby.kiggen@essential-it.be}{robby.kiggen@essential-it.be}}
        \\newline
          %{\\myauthorfont\\href{http://www.essential-it.be}{\\@degree}}
        \\newline
    {\\myauthorfont\\@date\\par}
\\end{raggedright}
}};
\\end{tikzpicture}
%Don't change
