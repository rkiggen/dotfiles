...
ask=`yad --list --separator='' --title="Settings" --column="0" "Audio" "Display" "Network Connections" "Wi-Fi Network" "Mouse and Keyboard" "Polybar Config" "i3 Config" --width=100 --height=300 --hide-header`
